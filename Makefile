...
ifdef debug
CXXFLAGS   = -DWITHGPU -march=native -mtune=native -Wno-unused-result -Wno-write-strings -g -I. -I$(CUDA)/include
else
CXXFLAGS   = -DWITHGPU -march=native -mtune=native -Wno-unused-result -Wno-write-strings -O3 -I. -I$(CUDA)/include
endif
